    ...
    return (
        <div className="pt-[122px]">
            <nav className="tab-list-container top-[50px]">
                <ul className="tab-list flex justify-between max-w-[1080px]">
                    <li className="tab-item tab1 hover:text-[#0088d2] group">
                        <a className="tab-inner ">
                            <span className="tab-icon icon-star mr-2"></span>
                            <span className="tab-label group-hover:text-[#0088d2]">精選</span>
                        </a>
                        <div className="tab-bar"></div>
                    </li>
                    <li className="tab-item tab2 hover:text-[#00579c] group ">
                        <a className="tab-inner">
                            <span className="tab-icon icon-learn mr-2"></span>
                            <span className="tab-label group-hover:text-[#00579c]">學習</span>
                        </a>
                        <div className="tab-bar"></div>
                    </li>
                    <li className="tab-item tab3 hover:text-[#ffa826] group ">
                        <a className="tab-inner">
                            <span className="tab-icon icon-art mr-2"></span>
                            <span className="tab-label group-hover:text-[#ffa826]">藝文</span>
                        </a>
                        <div className="tab-bar"></div>
                    </li>
                    <li className="tab-item tab4 hover:text-[#00b4b2] group">
                        <a className="tab-inner">
                            <span className="tab-icon icon-experience mr-2"></span>
                            <span className="tab-label group-hover:text-[#00b4b2]">體驗</span>
                        </a>
                        <div className="tab-bar"></div>
                    </li>
                </ul>
            </nav>
                <Carousel autoplay={false} arrows className="mt-[10px] mb-[14px]">
                <img className="object-contain" src="https://static.accupass.com/eventbanner/2502030803422063300661.jpg" alt=""/>
                <img className="object-contain" src="https://static.accupass.com/eventbanner/2408271309098543704770.jpg" alt=""/>
                </Carousel>   
            <div className="container max-w-[1080px]">
                ...
                <div className="article-wrap">
                    ...
                    <div className="flex justify-between gap-x-[20px] whitespace-nowrap">
                        {articleData.filter(item => item.category === 'news-1').map
                        ((item) =>(
                            <ArticleCard
                                key={item.id}
                                image={item.image}
                ...
                <div className="themes-wrap">
                    ...
                    <div className="flex flex-wrap gap-x-[30px] gap-y-[16px] whitespace-nowrap">
                        {recommendData.filter(item => item.category === 'featured-1').map
                        ((item) =>(
                        <EventCard
                            key={item.id} 
                            image={item.image}
                ...
                <div className="article-wrap">
                    <h2 className="article-title">每天一點新鮮事</h2>
                    <div className="flex justify-between gap-x-[20px] whitespace-nowrap">
                        {articleData.filter(item => item.category === 'news-2').map
                        ((item) =>(
                            <ArticleCard
                                key={item.id}
                                image={item.image}
                ...
                <div className="themes-wrap">
                    <h2 className="theme-title">精選活動</h2>
                    <div className="flex flex-wrap gap-x-[30px] gap-y-[16px] whitespace-nowrap">
                        {recommendData.filter(item => item.category === 'featured-2').map
                        ((item) =>(
                        <EventCard
                            key={item.id} 
                            image={item.image}
                ...
                <div className="themes-wrap">
                    <h2 className="theme-title">精選活動</h2>
                    <div className="flex flex-wrap gap-x-[30px] gap-y-[16px] whitespace-nowrap">
                        {recommendData.filter(item => item.category === 'featured-3').map
                        ((item) =>(
                        <EventCard
                            key={item.id} 
                            image={item.image}
